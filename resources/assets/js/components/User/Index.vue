   ...
   <div>
        <div class="user">
            <div class="row-fluid">
                ...
                <!-- aside -->
                <div class="user-aside span3" v-if="userInfo">
                    <div class="people">

                        <div class="basic-info">
                            <div class="avatar">
                                <img :src="userInfo.avatar" alt="3">
                            </div>
                            <h3><a style="display: inline;">{{userInfo.name}}</a></h3>
                        </div>

                        <div class="user-stats">
                            <ul class="clearfix">
                                <li>
                                    <a href=""><b>{{userInfo.followers_count}}</b><span>关注</span></a>
                                </li>
                                <li>
                                    <a href=""><b>{{userInfo.followings_count}}</b><span>粉丝</span></a>
                                </li>
                                <br>
                                <li>
                                    <a href=""><b>{{userInfo.contents_count}}</b><span>文章</span></a>
                                </li>

                                <li>
                                    <a><b>{{userInfo.likes_count}}</b><span>收获喜欢</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="span9 offset3 recent-post">
                    ...
                    <ul class="nav nav-tabs nav-articles">
                        <li :class="{'active':(style == 'content')}">
                            <a data-pjax="list-container" @click="change('content')" style="cursor:pointer">
                                <i class="fa fa-file-text-o"></i> 最新文章
                            </a>      </li>
                        <li :class="{'active':(style == 'activity')}">
                            <a data-pjax="list-container" @click="change('activity')" style="cursor:pointer">
                                <i class="fa fa-users"></i> 最新动态
                            </a>    </li>

                    </ul>
                    <div class="tab-content">
                        <div id="list-container" class="tab-pane active"><div class="tab-pane timeline">
                            <div class="timeline-list" >


                                <ul class="timeline-content" >
                                    <div v-for="activity in activities">
                                    <li class="comment" v-if="activity.conversation_type=='Comment'&& activity.conversation_content && style=='activity'">
                                        <div class="avatar-container">
                                            <div class="avatar">
                                                <a target="_blank" href="/users/a0edc6be524f">
                                                    <img :src="userInfo.avatar" alt="3">
                                                </a>    </div>
                                        </div>
                                        <p>
                                        ...
                                        <li class="user-update article" v-if="activity.conversation_type=='Article'&&activity.conversation_content">
                                        <div class="avatar-container">
                                            <div class="avatar">
                                                <a target="_blank" href="/users/a0edc6be524f">
                                                    <img :src="userInfo.avatar" alt="3">
                                    ...
                                    <li class="user-update" v-if="activity.conversation_type=='User'">
                                        <div class="avatar-container">
                                            <div class="avatar">
                                                <a target="_blank" href="/users/a0edc6be524f">
                                                    <img :src="userInfo.avatar" alt="3">
                                          ...
                                          <span>
                                            <a target="_blank" href="/users/a0edc6be524f">{{activity.name}}</a> 加入mario<b></b>
                                          </span>
                                        <div class="meta">
                                            <time>{{activity.created_at}}</time>
                                        </div>
...
<style>
    ...
    body.night-mode .timeline-content .article .article-content,
    body.night-mode .timeline-content .comment-content   {
